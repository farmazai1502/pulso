...
Pulso is a family medical journal app for tracking health records, medications, appointments, and self-test readings across multiple family members, with weekly AI-generated health reports and early-warning flags.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "221915169+farmazai1502@users.noreply.github.com"
  git config user.name "farmazai1502"
  ```
